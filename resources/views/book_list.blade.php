        ...
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                            ...
                            <div class="col-sm-12">
                                <form class="form-inline mtop-10" style="float:right;">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control mb-2 mr-sm-2" type="text" name="search_by_name" id="search_by_name" value="" placeholder="Search by keyword">
                                    </div>
                                    <div class="form-group">
                                        <button type="button" class="btn btn-success mb-2" id="search">Search</button>
                                    </div>
                                    <div class="form-group">
                                        <button data-toggle="modal" data-target="#updateBookData" type="button" class="btn btn-success mb-2" id="search" onclick="updateBookData({{htmlspecialchars(json_encode([]), ENT_QUOTES, 'UTF-8')}})">Add new book</button>
                                    </div>
                                    <div class="form-group">
                                        <?php
                    ...
                    <div class="modal fade" id="updateBookData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="margin-top: 200px;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="POST" action="{{route('updateBookDetails')}}">
                                    ...
                                    <div class="modal-body" style="display: inline-block; padding: 0 0 0 15px; width: 80%;">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row form-group">
                                                <label for="genre" class="col-sm-3 control-label">Discount Percent:</label>
                                                <div class="col-sm-9">
